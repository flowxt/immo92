...
export default function AppartementChatou3Pieces() {
  const [showCalculator, setShowCalculator] = useState(false);

  const propertyImages = [
    "/photos/benjamin/ext.jpeg",
    "/photos/benjamin/immeuble.jpeg",
    "/photos/benjamin/sejour.jpeg",
    "/photos/benjamin/balcon.jpeg",
    "/photos/benjamin/entree.jpeg",
    "/photos/benjamin/chambre.jpeg",
    "/photos/benjamin/sbd.jpeg",
  ];

  const propertyData = {
    id: 10,
    title: "Appartement 3 pièces - Chatou",
    location: "78400, Chatou",
    price: "327 000 €",
    lat: 48.8953,
    lng: 2.1574,
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span className="text-base sm:text-lg">78400, Chatou</span>
                  </div>
                </div>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none text-gray-600 space-y-4">
                <p>
                  À Chatou, à la lisière de Carrières-sur-Seine, ce charmant
                  appartement trois pièces de 70 m² se situe dans une résidence
                  paisible, sécurisée, arborée et équipée d&apos;un ascenseur.
                </p>
                <p>Le séjour lumineux de 20 m² s&apos;ouvre sur un balcon.</p>
                <p>
                  La grande cuisine aménagée favorise la convivialité, tandis
                  que les deux chambres offrent un confort appréciable.
                </p>
                <p>
                  Vous bénéficiez également d&apos;un parking et d&apos;une cave
                  privatifs.
                </p>
                <p>
                  L&apos;immeuble, fraîchement ravalé et isolé par
                  l&apos;extérieur, allie charme et performance énergétique avec
                  son chauffage individuel au gaz (DPE classe C).
                </p>
                <p className="font-semibold text-green-600">
                  Cette petite copropriété à taille humaine offre un cadre de
                  vie serein et agréable au quotidien.
                </p>
              </div>
            </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="flex justify-between py-3 border-b">
                    ...
                    <span className="font-semibold text-gray-900">1er / 3</span>
                  </div>
                  <div className="flex justify-between py-3 border-b">
                  ...
                  <div className="flex justify-between py-3 border-b">
                    ...
                    <span className="font-semibold text-gray-900">1980</span>
                  </div>
                  <div className="flex justify-between py-3 border-b">
                  ...
                  <div className="flex justify-between py-3 border-b">
                    ...
                    <span className="font-semibold text-gray-900">71 m²</span>
                  </div>
                  <div className="flex justify-between py-3 border-b">
                    <span className="text-gray-600">Balcon</span>
                    <span className="font-semibold text-gray-900">4.15 m²</span>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex justify-between py-3 border-b">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex justify-between py-3 border-b">
                  ...
                  <span className="font-semibold text-gray-900">19.95 m²</span>
                </div>
                <div className="flex justify-between py-3 border-b">
                  <span className="text-gray-600">Cuisine</span>
                  <span className="font-semibold text-gray-900">10.65 m²</span>
                </div>
                <div className="flex justify-between py-3 border-b">
                  <span className="text-gray-600">Chambre 1</span>
                  <span className="font-semibold text-gray-900">11.2 m²</span>
                </div>
                <div className="flex justify-between py-3 border-b">
                  <span className="text-gray-600">Chambre 2</span>
                  <span className="font-semibold text-gray-900">9.17 m²</span>
                </div>
                <div className="flex justify-between py-3 border-b">
                  <span className="text-gray-600">Entrée</span>
                  <span className="font-semibold text-gray-900">8.62 m²</span>
                </div>
                <div className="flex justify-between py-3 border-b">
                  <span className="text-gray-600">Salle de bains</span>
                  <span className="font-semibold text-gray-900">4.47 m²</span>
                </div>
                <div className="flex justify-between py-3 border-b">
                  <span className="text-gray-600">Balcon</span>
                  <span className="font-semibold text-gray-900">4.15 m²</span>
                ...
                <div className="flex justify-between py-3 border-b">
                  ...
                  <span className="font-semibold text-gray-900">1.16 m²</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-4">
                📍 Chatou, à la lisière de Carrières-sur-Seine - Cadre verdoyant
                et calme
              </p>
            </motion.div>
            ...
            >
              <p className="text-xs text-gray-600 leading-relaxed">
                ...
                89071070000018 - 315 000 € honoraires exclus - Honoraires de
                3.81%TTC à charge acquéreur - Nombre de lots dans la
                copropriété: 30 - Montant moyen de la quote-part de charges
                courantes 1 920 €/an - Aucune procédure en cours (articles
                29-1A/29-1 loi 65-557, L.615-6 du CCH) - Classe énergie 95
                kWhEP/m².an (C) - Classe climat 18 kg CO2/m².an (C) - Montant
                estimé des dépenses annuelles d&apos;énergie pour un usage
                standard, établi à partir des prix de l&apos;énergie de
                l&apos;année 2021 : 736€ ~ 995€ - Les informations sur les
            ...
            <div className="sticky top-24 space-y-6">
              ...
              {showCalculator && (
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <MortgageCalculator compact={true} propertyPrice={327000} />
