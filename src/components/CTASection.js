    ...
    <section className={`relative overflow-hidden ${isLight ? 'bg-gradient-to-b from-gray-50 to-white' : 'bg-gray-900'} py-20 sm:py-24`}>
      ...
      {!isLight && (
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#2998a6] rounded-full blur-3xl" />
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              <svg className={`w-5 h-5 ${isLight ? 'text-[#2998a6]' : 'text-[#2998a6]/80'}`} fill="currentColor" viewBox="0 0 20 20">
