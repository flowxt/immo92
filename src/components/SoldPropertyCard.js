...
export default function SoldPropertyCard({ property }) {
  return (
    <Link href={`/biens-vendus/${property.slug}`}>
      ...
      >
      {/* Badge VENDU */}
      <div className="absolute top-4 left-4 z-10 bg-green-600 text-white px-4 py-2 rounded-full font-bold text-sm shadow-lg">
        ✓ VENDU
      </div>
      ...
      <div className="p-6 flex-grow flex flex-col">
        ...
        <div className="mt-auto pt-4 border-t flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-gray-500">Vendu en {property.soldYear || "2025"}</div>
          </div>
