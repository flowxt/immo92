  ...
  return (
    <div className={`${centered ? 'mx-auto max-w-3xl text-center' : ''} mb-16`}>
      ...
      {label && (
        ...
        >
          <span className="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-semibold bg-gradient-to-r from-[#2998a6] via-[#0d6c8a] to-[#06465c] text-white shadow-sm">
            {label}
          </span>
        </motion.div>
      )}
      ...
      {showLine && centered && (
        <motion.div
          ...
          className="mx-auto w-20 h-1 bg-gradient-to-r from-[#1e3771] via-[#2998a6] to-amber-500 rounded-full mb-6"
        />
      )}
